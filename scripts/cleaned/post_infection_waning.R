...
combined_waning_plot_dose2 <- ggplot() +
...
print(combined_waning_plot_dose2)

####################################

# Post-Infection and Post-Vaccine (Dose 3)
combined_waning_plot_dose3 <- ggplot() +
...
labs(x = "Days since event", y = "WT sVNT Inhibition (%)", 
     title = "Waning: Post Third-Dose Vaccine vs Post-Infection") +
...
# Print the plot
print(combined_waning_plot_dose3)

# Save
ggsave("post_infection_waning_plot.pdf", plot = post_infection_waning_plot, width = 8, height = 6)
ggsave("combined_waning_plot_dose2.pdf", plot = combined_waning_plot_dose2, width = 10, height = 6)
ggsave("combined_waning_plot_dose3.pdf", plot = combined_waning_plot_dose3, width = 12, height = 6)
