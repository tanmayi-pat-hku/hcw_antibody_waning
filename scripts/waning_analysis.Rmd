...
ggplot() +
  geom_jitter(data = one_valid_perms,
              aes(x = one_dose_permutation, y = !!sym(response_colq), color = one_dose_permutation),  # Use the response column passed
              alpha = 0.8, width = 0.18, size = 2.5) +
  geom_crossbar(data = one_dose_medians,
                aes(x = one_dose_permutation, y = median,  
  ...
  labs(x = "Dose Permutation",
       y = "Antibody SVNT Value") +  
  theme_bw(base_size = 12) +  
  theme(plot.title = element_text(face = "bold", size = 14),
        axis.title = element_text(face = "bold"),
        axis.text.x = element_text(angle = 0, hjust = 0.5, vjust = 0.5, face = "bold"),  # Horizontal labels
...
ggplot() +
  ...
  geom_crossbar(data = two_dose_medians,
                aes(x = two_dose_permutation, y = median, 
                    ymin = median, ymax = median),  
                width = 0.5, colour = "black", size = 0.5) +
  scale_x_discrete(labels = two_labels, expand = expansion(add = c(0.5, 0.5))) +
  scale_y_continuous(limits = c(0, 110), breaks = seq(0, 100, by = 20)) +
  labs(x = "Dose Permutation",
       y = "Antibody SVNT Value") +  
  theme_bw(base_size = 12) +  
...
ggplot() +
  ...
  geom_crossbar(data = three_dose_medians,
                aes(x = three_dose_permutation, y = median, 
                    ymin = median, ymax = median),  
                width = 0.5, colour = "black", size = 0.5) +
  scale_x_discrete(labels = three_labels, expand = expansion(add = c(0.5, 0.5))) +
  scale_y_continuous(limits = c(0, 110), breaks = seq(0, 100, by = 20)) +
  labs(x = "Dose Permutation",
       y = "Antibody SVNT Value") +  
  theme_bw(base_size = 12) +  
...
ggplot() +
  ...
  geom_crossbar(data = four_dose_medians,
                aes(x = four_dose_permutation, y = median, 
                    ymin = median, ymax = median),  
                width = 0.5, colour = "black", size = 0.5) +
  scale_x_discrete(labels = four_labels, expand = expansion(add = c(0.5, 0.5))) +
  scale_y_continuous(limits = c(0, 110), breaks = seq(0, 100, by = 20)) +
  labs(x = "Dose Permutation",
       y = "Antibody SVNT Value") +  
  theme_bw(base_size = 12) +  
